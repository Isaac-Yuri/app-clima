  ...
  return (
    <div className="relative w-full h-full flex items-center">
      ...
      <input
        ...
        type="text"
        value={city}
        className="w-full h-full bg-transparent border-2 border-white border-opacity-10 outline-none rounded-lg md:text-xl text-sm text-white font-medium uppercase p-4 px-11 placeholder-[#e0e0e0] placeholder-capitalize"
      />
      <button
